...
This directory is based on `github.com/sagernet/sing-quic` tag
`v0.7.0` (commit `4ab2eceaac81`, the same source as `v0.7.0-beta.4`) and remains under the upstream
license in `LICENSE`.
